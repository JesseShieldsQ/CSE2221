...
public final class ABCDGuesser1 {
    ...
    public static void main(String[] args) {
        ...
        out.println("What would you like your value of w to be? (must be > 0 and not 1)");
        double w = getPositiveDoubleNotOne(in, out);
        out.println("What would you like your value of w to be? (must be > 0 and not 1");
        double x = getPositiveDoubleNotOne(in, out);
        out.println("What would you like your value of y to be? (must be > 0 and not 1");
        double y = getPositiveDoubleNotOne(in, out);
        out.println("What would you like your value of z to be? (must be > 0 and not 1");
