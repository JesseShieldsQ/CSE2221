...
public final class NNCalcView1 extends JFrame implements NNCalcView {
    ...
    public NNCalcView1() {
        ...
        //Local variables to contextualize magic numbers
        final int zero = 0;
        final int one = 1;
        final int two = 2;
        final int three = 3;
        ...
        this.bDigits[zero] = new JButton("0");
        this.bDigits[one] = new JButton("1");
        this.bDigits[two] = new JButton("2");
