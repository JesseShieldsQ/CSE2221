...
public final class NNCalcController1 implements NNCalcController {
    ...
    private static void updateViewToMatchModel(NNCalcModel model, NNCalcView view) {
        ...
        //Sets naturalnumber variables for operations
        NaturalNumber output = model.top();
        NaturalNumber input = model.bottom();

        //Shows operands in appropriate screens
        view.updateTopDisplay(output);
        view.updateBottomDisplay(input);

        //Creates flag to check if any given operation is allowed
        boolean allowed = true;

        //Checks if the divisor is a non-zero number, and allows division if so
        ...
        //Checks if the bottom is greater than the top, and if not, allows
        //subtraction
        ...
        //Checks if power is allowed by seeing if the bottom number exceeds the
        //integer max
        ...
        //Checks if root is greater than one and if the bottom number is larger
        //than the integer max value
